...
public class Printf_RGB extends JFrame { // 需要继承JFrame
	public Printf_RGB(String title)

	{
		...
		frame.setBounds(736,210,500,550); // 设置窗口的属性 窗口位置以及窗口的大小
...
//		frame.getLayeredPane().add(label, Integer.valueOf(Integer.MIN_VALUE));// 标签添加到层面板
		...
		String a = mainBody.getRGB();
//		JPanel panel=new JPanel();
//		panel.setBounds(0,0,500,600);
//		panel.setVisible(true);
		//panel.setBackground(Color.BLACK);
		//frame.add(panel);
		JLabel Label1 = new JLabel("该叶子的RGB均值为:" + a ); // 创建一个标签 并设置初始内容
