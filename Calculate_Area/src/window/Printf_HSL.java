...
public class Printf_HSL extends JFrame { // 需要继承JFrame
	public Printf_HSL(String title)
...
//		frame.getLayeredPane().add(label, Integer.valueOf(Integer.MIN_VALUE));// 标签添加到层面板
		...
		String b = mainBody.getHSL();
//		JPanel panel=new JPanel();
//		panel.setBounds(0,0,500,600);
//		panel.setVisible(true);
		//panel.setBackground(Color.BLACK);
		//frame.add(panel);
		JLabel Label1 = new JLabel("RGB转HSL值为:" + b ); // 创建一个标签 并设置初始内容
